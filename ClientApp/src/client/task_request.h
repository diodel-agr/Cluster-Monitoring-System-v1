...
#define TASK_READY				0x08
#define TASK_UPDATE_FILE		0x09

/* response defines. */
#define RESP_SUCCESS			0x10	/* request success response. */
#define RESP_LOG_LIST			0x11
#define RESP_LOG_LIST_END		0x12
#define RESP_LOG				0x13
#define RESP_LOG_END			0x14
#define RESP_CLIENT_LIST		0x15

/* error defines. */
#define ERR_MESSAGE 			0x20 	/* message format error. */
#define ERR_AUTHENTICATE 		0x21 	/* authentication error. */
#define ERR_FILE_NOT_FOUND		0x22
